...
function generateReportContent(type, range) {
 const reports = {
 inventory: `
 <div class="report-content">
 <h3>Inventory Report - Last ${range} Days</h3>
 ...
 shipment: `
 <div class="report-content">
 <h3>Shipment Report - Last ${range} Days</h3>
 <div class="report-stats">
 <div class="report-stat">
 ...
 <div class="bar" style="width: 9%">9%</div>
 </div>
 <div class="chart-bar">
 <span>Cancelled</span>
 ...
 space: `
 <div class="report-content">
 <h3>Space Utilization Report - Last ${range} Days</h3>
 <div class="report-stats">
 <div class="report-stat">
 ...
 maintenance: `
 <div class="report-content">
 <h3>Maintenance Report - Last ${range} Days</h3>
 <div class="report-stats">
 <div class="report-stat">
 <h4>Total Tasks</h4>
 <p>23</p>
 ...
 <div class="chart-bar">
 <span>Completed</span>
 <div class="bar" style="width: 87%">87%</div>
 </div>
 <div class="chart-bar">
 <span>Pending</span>
 <div class="bar" style="width: 13%">13%</div>
 </div>
 </div>
 </div>
 </div>
 ...
 performance: `
 <div class="report-content">
 <h3>Performance Analytics - Last ${range} Days</h3>
 <div class="report-stats">
 <div class="report-stat">
 ...
 return reports[type] || '<p>Report not available</p>';
}
